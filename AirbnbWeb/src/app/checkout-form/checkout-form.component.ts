...
@Component({
  ...
  imports: [MatFormFieldModule, PricePipe, MatInputModule, MatDatepickerModule, MatButtonModule, NgxMaterialTimepickerModule, CommonModule, FormsModule, PriceBoxComponent, RouterModule, ReactiveFormsModule, NgIf],
